...
/**
 * A class implements the CreditCheckor interface, and can be used to get credit score from Company1
 * 
 * @author Qifeng Huang
 *
 */
public class Company1CreditCheckor implements CreditCheckor {

	/**
	 * This method call the company1's credit score service based on the loan application
